...
La extensión del sistema para integrar las herramientas de análisis de datos de P2_AP-IA y las capacidades de visualización de P3_AP-IA permitiría crear una plataforma unificada. El desarrollo de capacidades multilingües permitiría su aplicación en contextos internacionales, mientras que la integración con APIs bancarias directas podría eliminar la necesidad de importación manual de datos. La extensión a colaboración familiar y el desarrollo de interfaces de voz conversacional representan oportunidades adicionales para mejorar la experiencia del usuario \cite{memory_in_agents2023}.